		...
		<div className={props.cls || ''}>
			<div className={`frame ${props.frameType}`} style={props.frameStyle || {}}>
				<header className="frame-header">
					...
					<DisplayStyleBlock 
						displayStyleIsActive={props.displayStyleIsActive} 
						excerptDisplayStyles={props.excerptDisplayStyles} 
						excerptDisplayStyleActive={props.excerptDisplayStyleActive} 
...
const Page = props => {
	return (
		...
		>
			{props.children}
			{props.pagination === true ? <Pagination {...props} /> : ''}
		</Frame>
	);
};
