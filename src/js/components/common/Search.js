    ...
    return (
      <div className="search-wrapper">
        <div className="search-block">
          ...
          }} onFocus={this.removePlaceHolder} onBlur={this.addPlaceHolder} placeholder="Search"/>

          <button className="search-button" onClick={this.getSearchQuery}>
            <Link to="/search"><Icon fa="search"/></Link>
          </button>
        </div>
      </div>
    );
