  ...
  render() {
    return (
      <Page headerTitle="About" cls="about-page">
        ...
        <p className="about-paragraph">All source code is avaible on github: <a className="about-link" href="https://github.com/s-chernomorec/excerpts">https://github.com/s-chernomorec/excerpts</a></p>
