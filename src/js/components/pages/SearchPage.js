...
class SearchPage extends Component {
	...
	render() {
		...
		let slicedExcerpts, titleIsProvided;
		...
		return (
    	<Page 
				headerTitle={ "Search results for: " + this.props.searchQuery } 
				pagination={!!paginationIsActive} 
				options={paginationOptions} 
				navigate={(pageNumber)=>this.navigate(pageNumber)} 
				displayStyleIsActive={true} 
				excerptDisplayStyles={this.props.excerptDisplayStyles}
				excerptDisplayStyleActive={this.props.activeExcerptDisplayStyle}
				changeDisplayStyle={(style) => this.props.changeDisplayStyle(style)}
			>
    		<ExcerptList
    			excerpts={slicedExcerpts}
    			titleIsProvided={titleIsProvided}
    			...
    			editExcerpt={ (excerpt) => this.props.editExcerpt(excerpt) }
					...
					activeExcerptDisplayClass={ this.props.activeExcerptDisplayStyle.class }
    		/>
      </Page>
    );
  }
